...
{
    // [START storage_v2_generated_Storage_UpdateObject_async_flattened]
    ...
    public sealed partial class GeneratedStorageClientSnippets
    {
        ...
        public async Task UpdateObjectAsync()
        {
            ...
            // Make the request
            Object response = await storageClient.UpdateObjectAsync(@object, updateMask);
        }
    }
    // [END storage_v2_generated_Storage_UpdateObject_async_flattened]
}
