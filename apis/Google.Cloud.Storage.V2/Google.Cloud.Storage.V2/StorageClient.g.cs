...
namespace Google.Cloud.Storage.V2
{
    ...
    public sealed partial class StorageSettings : gaxgrpc::ServiceSettingsBase
    {
        ...
        private StorageSettings(StorageSettings existing) : base(existing)
        {
            ...
            DeleteNotificationSettings = existing.DeleteNotificationSettings;
            GetNotificationSettings = existing.GetNotificationSettings;
            CreateNotificationSettings = existing.CreateNotificationSettings;
        ...
        /// <summary>
        /// <see cref="gaxgrpc::CallSettings"/> for synchronous and asynchronous calls to
        /// <c>StorageClient.DeleteNotification</c> and <c>StorageClient.DeleteNotificationAsync</c>.
        /// </summary>
        /// <remarks>
        /// <list type="bullet">
        /// <item><description>Initial retry delay: 1000 milliseconds.</description></item>
        ...
        /// </list>
        /// </remarks>
        public gaxgrpc::CallSettings DeleteNotificationSettings { get; set; } = gaxgrpc::CallSettingsExtensions.WithRetry(gaxgrpc::CallSettings.FromExpiration(gax::Expiration.FromTimeout(sys::TimeSpan.FromMilliseconds(60000))), gaxgrpc::RetrySettings.FromExponentialBackoff(maxAttempts: 5, initialBackoff: sys::TimeSpan.FromMilliseconds(1000), maxBackoff: sys::TimeSpan.FromMilliseconds(60000), backoffMultiplier: 2, retryFilter: gaxgrpc::RetrySettings.FilterForStatusCodes(grpccore::StatusCode.DeadlineExceeded, grpccore::StatusCode.Unavailable)));

        /// <summary>
        /// <see cref="gaxgrpc::CallSettings"/> for synchronous and asynchronous calls to
        /// <c>StorageClient.GetNotification</c> and <c>StorageClient.GetNotificationAsync</c>.
        /// </summary>
        /// <remarks>
        /// <list type="bullet">
        /// <item><description>Initial retry delay: 1000 milliseconds.</description></item>
        ...
        /// <summary>
        /// <see cref="gaxgrpc::CallSettings"/> for synchronous and asynchronous calls to
        /// <c>StorageClient.CreateNotification</c> and <c>StorageClient.CreateNotificationAsync</c>.
        /// </summary>
        /// <remarks>
        /// <list type="bullet">
        /// <item><description>Initial retry delay: 1000 milliseconds.</description></item>
        ...
        /// </list>
        /// </remarks>
        public gaxgrpc::CallSettings CreateNotificationSettings { get; set; } = gaxgrpc::CallSettingsExtensions.WithRetry(gaxgrpc::CallSettings.FromExpiration(gax::Expiration.FromTimeout(sys::TimeSpan.FromMilliseconds(60000))), gaxgrpc::RetrySettings.FromExponentialBackoff(maxAttempts: 5, initialBackoff: sys::TimeSpan.FromMilliseconds(1000), maxBackoff: sys::TimeSpan.FromMilliseconds(60000), backoffMultiplier: 2, retryFilter: gaxgrpc::RetrySettings.FilterForStatusCodes(grpccore::StatusCode.DeadlineExceeded, grpccore::StatusCode.Unavailable)));

        /// <summary>
        /// <see cref="gaxgrpc::CallSettings"/> for synchronous and asynchronous calls to
        /// <c>StorageClient.ListNotifications</c> and <c>StorageClient.ListNotificationsAsync</c>.
        /// </summary>
        /// <remarks>
        /// <list type="bullet">
        /// <item><description>Initial retry delay: 1000 milliseconds.</description></item>
    ...
    public abstract partial class StorageClient
    {
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>The RPC response.</returns>
        public virtual void DeleteNotification(DeleteNotificationRequest request, gaxgrpc::CallSettings callSettings = null) =>
            throw new sys::NotImplementedException();
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task DeleteNotificationAsync(DeleteNotificationRequest request, gaxgrpc::CallSettings callSettings = null) =>
            throw new sys::NotImplementedException();
        ...
        /// <param name="cancellationToken">A <see cref="st::CancellationToken"/> to use for this RPC.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task DeleteNotificationAsync(DeleteNotificationRequest request, st::CancellationToken cancellationToken) =>
            DeleteNotificationAsync(request, gaxgrpc::CallSettings.FromCancellationToken(cancellationToken));
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>The RPC response.</returns>
        public virtual void DeleteNotification(string name, gaxgrpc::CallSettings callSettings = null) =>
            DeleteNotification(new DeleteNotificationRequest
            {
                Name = gax::GaxPreconditions.CheckNotNullOrEmpty(name, nameof(name)),
            }, callSettings);
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task DeleteNotificationAsync(string name, gaxgrpc::CallSettings callSettings = null) =>
            DeleteNotificationAsync(new DeleteNotificationRequest
            {
                Name = gax::GaxPreconditions.CheckNotNullOrEmpty(name, nameof(name)),
            }, callSettings);
        ...
        /// <param name="cancellationToken">A <see cref="st::CancellationToken"/> to use for this RPC.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task DeleteNotificationAsync(string name, st::CancellationToken cancellationToken) =>
            DeleteNotificationAsync(name, gaxgrpc::CallSettings.FromCancellationToken(cancellationToken));
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>The RPC response.</returns>
        public virtual void DeleteNotification(NotificationName name, gaxgrpc::CallSettings callSettings = null) =>
            DeleteNotification(new DeleteNotificationRequest
            {
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task DeleteNotificationAsync(NotificationName name, gaxgrpc::CallSettings callSettings = null) =>
            DeleteNotificationAsync(new DeleteNotificationRequest
            {
                NotificationName = gax::GaxPreconditions.CheckNotNull(name, nameof(name)),
            }, callSettings);
        ...
        /// <param name="cancellationToken">A <see cref="st::CancellationToken"/> to use for this RPC.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task DeleteNotificationAsync(NotificationName name, st::CancellationToken cancellationToken) =>
            DeleteNotificationAsync(name, gaxgrpc::CallSettings.FromCancellationToken(cancellationToken));
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>The RPC response.</returns>
        public virtual Notification CreateNotification(CreateNotificationRequest request, gaxgrpc::CallSettings callSettings = null) =>
            throw new sys::NotImplementedException();
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<Notification> CreateNotificationAsync(CreateNotificationRequest request, gaxgrpc::CallSettings callSettings = null) =>
            throw new sys::NotImplementedException();
        ...
        /// <param name="cancellationToken">A <see cref="st::CancellationToken"/> to use for this RPC.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<Notification> CreateNotificationAsync(CreateNotificationRequest request, st::CancellationToken cancellationToken) =>
            CreateNotificationAsync(request, gaxgrpc::CallSettings.FromCancellationToken(cancellationToken));
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>The RPC response.</returns>
        public virtual Notification CreateNotification(string parent, Notification notification, gaxgrpc::CallSettings callSettings = null) =>
            CreateNotification(new CreateNotificationRequest
            {
                Parent = gax::GaxPreconditions.CheckNotNullOrEmpty(parent, nameof(parent)),
                Notification = gax::GaxPreconditions.CheckNotNull(notification, nameof(notification)),
            }, callSettings);
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<Notification> CreateNotificationAsync(string parent, Notification notification, gaxgrpc::CallSettings callSettings = null) =>
        ...
        /// <param name="cancellationToken">A <see cref="st::CancellationToken"/> to use for this RPC.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<Notification> CreateNotificationAsync(string parent, Notification notification, st::CancellationToken cancellationToken) =>
            CreateNotificationAsync(parent, notification, gaxgrpc::CallSettings.FromCancellationToken(cancellationToken));
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>The RPC response.</returns>
        public virtual Notification CreateNotification(BucketName parent, Notification notification, gaxgrpc::CallSettings callSettings = null) =>
            CreateNotification(new CreateNotificationRequest
            {
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<Notification> CreateNotificationAsync(BucketName parent, Notification notification, gaxgrpc::CallSettings callSettings = null) =>
            CreateNotificationAsync(new CreateNotificationRequest
            {
                ParentAsBucketName = gax::GaxPreconditions.CheckNotNull(parent, nameof(parent)),
                Notification = gax::GaxPreconditions.CheckNotNull(notification, nameof(notification)),
        ...
        /// <param name="cancellationToken">A <see cref="st::CancellationToken"/> to use for this RPC.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<Notification> CreateNotificationAsync(BucketName parent, Notification notification, st::CancellationToken cancellationToken) =>
            CreateNotificationAsync(parent, notification, gaxgrpc::CallSettings.FromCancellationToken(cancellationToken));
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A pageable sequence of <see cref="Notification"/> resources.</returns>
        public virtual gax::PagedEnumerable<ListNotificationsResponse, Notification> ListNotifications(BucketName parent, string pageToken = null, int? pageSize = null, gaxgrpc::CallSettings callSettings = null) =>
            ListNotifications(new ListNotificationsRequest
            {
                ParentAsBucketName = gax::GaxPreconditions.CheckNotNull(parent, nameof(parent)),
                PageToken = pageToken ?? "",
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A pageable asynchronous sequence of <see cref="Notification"/> resources.</returns>
        public virtual gax::PagedAsyncEnumerable<ListNotificationsResponse, Notification> ListNotificationsAsync(BucketName parent, string pageToken = null, int? pageSize = null, gaxgrpc::CallSettings callSettings = null) =>
            ListNotificationsAsync(new ListNotificationsRequest
            {
                ParentAsBucketName = gax::GaxPreconditions.CheckNotNull(parent, nameof(parent)),
                PageToken = pageToken ?? "",
    ...
    public sealed partial class StorageClientImpl : StorageClient
    {
        ...
        private readonly gaxgrpc::ApiCall<DeleteNotificationRequest, wkt::Empty> _callDeleteNotification;

        private readonly gaxgrpc::ApiCall<GetNotificationRequest, Notification> _callGetNotification;

        private readonly gaxgrpc::ApiCall<CreateNotificationRequest, Notification> _callCreateNotification;
        ...
        public StorageClientImpl(Storage.StorageClient grpcClient, StorageSettings settings, mel::ILogger logger)
        {
            ...
            _callCreateBucket = clientHelper.BuildApiCall<CreateBucketRequest, Bucket>("CreateBucket", grpcClient.CreateBucketAsync, grpcClient.CreateBucket, effectiveSettings.CreateBucketSettings).WithGoogleRequestParam("project", request => request.Parent);
            ...
            _callDeleteNotification = clientHelper.BuildApiCall<DeleteNotificationRequest, wkt::Empty>("DeleteNotification", grpcClient.DeleteNotificationAsync, grpcClient.DeleteNotification, effectiveSettings.DeleteNotificationSettings).WithExtractedGoogleRequestParam(new gaxgrpc::RoutingHeaderExtractor<DeleteNotificationRequest>().WithExtractedParameter("bucket", "^(projects/[^/]+/buckets/[^/]+)(?:/.*)?$", request => request.Name));
            Modify_ApiCall(ref _callDeleteNotification);
            Modify_DeleteNotificationApiCall(ref _callDeleteNotification);
            _callGetNotification = clientHelper.BuildApiCall<GetNotificationRequest, Notification>("GetNotification", grpcClient.GetNotificationAsync, grpcClient.GetNotification, effectiveSettings.GetNotificationSettings).WithExtractedGoogleRequestParam(new gaxgrpc::RoutingHeaderExtractor<GetNotificationRequest>().WithExtractedParameter("bucket", "^(projects/[^/]+/buckets/[^/]+)(?:/.*)?$", request => request.Name));
            Modify_ApiCall(ref _callGetNotification);
            Modify_GetNotificationApiCall(ref _callGetNotification);
            _callCreateNotification = clientHelper.BuildApiCall<CreateNotificationRequest, Notification>("CreateNotification", grpcClient.CreateNotificationAsync, grpcClient.CreateNotification, effectiveSettings.CreateNotificationSettings).WithGoogleRequestParam("bucket", request => request.Parent);
            Modify_ApiCall(ref _callCreateNotification);
            Modify_CreateNotificationApiCall(ref _callCreateNotification);
            _callListNotifications = clientHelper.BuildApiCall<ListNotificationsRequest, ListNotificationsResponse>("ListNotifications", grpcClient.ListNotificationsAsync, grpcClient.ListNotifications, effectiveSettings.ListNotificationsSettings).WithGoogleRequestParam("bucket", request => request.Parent);
        ...
        partial void Modify_DeleteNotificationApiCall(ref gaxgrpc::ApiCall<DeleteNotificationRequest, wkt::Empty> call);

        partial void Modify_GetNotificationApiCall(ref gaxgrpc::ApiCall<GetNotificationRequest, Notification> call);

        partial void Modify_CreateNotificationApiCall(ref gaxgrpc::ApiCall<CreateNotificationRequest, Notification> call);
        ...
        partial void Modify_DeleteNotificationRequest(ref DeleteNotificationRequest request, ref gaxgrpc::CallSettings settings);

        partial void Modify_GetNotificationRequest(ref GetNotificationRequest request, ref gaxgrpc::CallSettings settings);

        partial void Modify_CreateNotificationRequest(ref CreateNotificationRequest request, ref gaxgrpc::CallSettings settings);
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>The RPC response.</returns>
        public override void DeleteNotification(DeleteNotificationRequest request, gaxgrpc::CallSettings callSettings = null)
        {
            Modify_DeleteNotificationRequest(ref request, ref callSettings);
            _callDeleteNotification.Sync(request, callSettings);
        }
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public override stt::Task DeleteNotificationAsync(DeleteNotificationRequest request, gaxgrpc::CallSettings callSettings = null)
        {
            Modify_DeleteNotificationRequest(ref request, ref callSettings);
            return _callDeleteNotification.Async(request, callSettings);
        }
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>The RPC response.</returns>
        public override Notification CreateNotification(CreateNotificationRequest request, gaxgrpc::CallSettings callSettings = null)
        {
            Modify_CreateNotificationRequest(ref request, ref callSettings);
            return _callCreateNotification.Sync(request, callSettings);
        }
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public override stt::Task<Notification> CreateNotificationAsync(CreateNotificationRequest request, gaxgrpc::CallSettings callSettings = null)
        {
            Modify_CreateNotificationRequest(ref request, ref callSettings);
            return _callCreateNotification.Async(request, callSettings);
        }
